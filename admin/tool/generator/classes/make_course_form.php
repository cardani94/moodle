...
class tool_generator_make_course_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('hidden', 'coursesize', $this->_customdata['coursesize']);
        $mform->setType('coursesize', PARAM_INT);
        ...
        $mform->addElement('textarea', 'coursecontent', get_string('coursecontent', 'tool_generator'),
            array('style' => 'width:900px;height:400px;font-family:monospace'));
        $mform->setType('coursecontent', PARAM_RAW);
        $mform->setDefault('coursecontent', $this->_customdata['coursecontent']);
