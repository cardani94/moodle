...
var DIALOGUE_NAME = 'Moodle dialogue',
    ...
    NON_MODAL_DEPRECATION_MESSAGE = 'The use of non modal dialogues is now deprecated';
...
Y.extend(DIALOGUE, Y.Panel, {
    ...
    initializer : function() {
        ...
        // Dialogues are now always modals to match aria spec.
        // Warn if someone is turning off the modal setting.
        this.after('modalChange', function() {
            if (!this.get('modal')) {
                Y.log(NON_MODAL_DEPRECATION_MESSAGE, 'warn', 'moodle-notification-dialogue');
            }
        });
...
Y.Base.modifyAttrs(DIALOGUE, {
    ...
    /**
     * Boolean determining whether the dialogue should be a modal.
     *
     * This is defaulting to true in order to match the ARIA specification
     * for dialogues.
     *
     * @attribute modal
     * @type Boolean
