...
class behat_permissions extends behat_base {
    ...
    public function i_set_the_following_system_permissions_of_role($rolename, $table) {
        ...
        $this->execute_step("behat_general::click_link", "Edit " . $this->escape($rolename) . " role",
            true, true);
        $this->execute_step("behat_permissions::i_fill_the_capabilities_form_with_the_following_permissions", $table,
            false, false);
    ...
    public function i_override_the_system_permissions_of_role_with($rolename, $table) {
        ...
        if (!$this->running_javascript()) {
            $this->execute_step("behat_forms::press_button", get_string('go'),
                true, true);
        }
        $this->execute_step("behat_permissions::i_fill_the_capabilities_form_with_the_following_permissions", $table,
            false, false);
    ...
    public function i_define_the_allowed_role_assignments_for_a_role_as($rolename, $table) {
        ...
        $this->execute_step("behat_general::click_link", "Allow role assignments",
            true, true);
        $this->execute_step("behat_permissions::i_fill_in_the_allowed_role_assignments_form_for_a_role_with",
