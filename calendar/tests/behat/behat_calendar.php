...
class behat_calendar extends behat_base {
    ...
    public function i_create_a_calendar_event_with_form_data($data) {
        ...
        $this->execute_step("behat_general::click_link", get_string('monththis', 'calendar'),
            true, true);
    ...
    public function i_create_a_calendar_event($data) {
        ...
        $this->execute_step("behat_general::i_click_on", array(get_string('newevent', 'calendar'), "button"),
            true, true);
        ...
        $this->execute_step("behat_general::assert_page_contains_text", $eventname,
            false, false);
    ...
    public function i_hover_over_day_of_this_month_in_calendar($day) {
        ...
        $this->execute_step("behat_general::i_hover", array($xpath, "xpath_element"),
            false, false);
