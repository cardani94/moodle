...
class behat_auth extends behat_base {
    ...
    public function i_log_in_as($username) {
        ...
        $this->execute_step('behat_forms::i_set_the_field_to', array('Username', $this->escape($username)),
            false, false);
        $this->execute_step('behat_forms::i_set_the_field_to', array('Password', $this->escape($username)),
            false, false);

        // Press log in button, no need to check for exceptions as it will checked after this step execution.
        $this->execute_step('behat_forms::press_button', get_string('login'),
            false, false);
    }
    ...
    public function i_log_out() {
        ...
        $this->execute_step('behat_general::click_link', get_string('logout'),
            false, false);
    }
}
