    ...
    public static function get_store_instance_summaries() {
        ...
        foreach ($stores as $name => $details) {
            ...
            $record = array(
                ...
                'supports' => array(
                    'multipleidentifiers' => $store ? $store->supports_multiple_identifiers() : null,
                    'dataguarantee' => $store ? $store->supports_data_guarantee() : null,
                    'nativettl' => $store ? $store->supports_native_ttl() : null,
                ...
                'warnings' => $store ? $store->get_warnings() : null
            );
