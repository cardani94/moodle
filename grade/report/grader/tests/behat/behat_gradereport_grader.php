...
class behat_gradereport_grader extends behat_base {
    ...
    public function i_click_away_from_student_and_grade_value($student, $itemname) {
        ...
        $this->execute_step('behat_general::i_take_focus_off_field', array($this->escape($xpath), 'xpath_element'),
            false, false);
    }
    ...
    public function i_should_see_grade_field($student, $itemname) {
        ...
        $this->execute_step('behat_general::should_be_visible', array($this->escape($xpath), 'xpath_element'),
            false, false);
    }
    ...
    public function i_should_not_see_grade_field($student, $itemname) {
        ...
        $this->execute_step('behat_general::should_not_exist', array($this->escape($xpath), 'xpath_element'),
            false, false);
    }
