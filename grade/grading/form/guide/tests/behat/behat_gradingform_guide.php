    ...
    public function i_grade_by_filling_the_marking_guide_with(TableNode $guide) {
        ...
        foreach ($criteria as $name => $criterion) {
            ...
            if ($criterionid) {
                ...
                $this->execute_step('behat_forms::i_set_the_field_to', array($criterionroot . '[score]', $points),
                    true, true);
                $this->execute_step('behat_forms::i_set_the_field_to', array($criterionroot . '[remark]', $criterion[1]),
                    true, true);
            }
        }
    }
