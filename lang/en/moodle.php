...
$string['loggedas'] = '{$a->realusername} as {$a->asusername}';
...
$string['noreaderenabled'] = 'No reader enabled';
...
$string['relatedfullnameuser'] = 'Affected user';
...
$string['selectreader'] = 'Select reader';
