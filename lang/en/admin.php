...
$string['allowhidingallblocks'] = 'Allow user to hide all blocks';
...
$string['configallowhidingallblocks'] = 'If enabled user will be able to hide all blocks, for pagelayouts supported by themes.';
